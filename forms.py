...
# CAMBIOS REALIZADOS
class RealizarReservaAdmin(FlaskForm):
    numId = StringField("N° Identificación del Usuario", validators = [DataRequired()])
    fechaInicio = DateField("Fecha de entrada", validators = [DataRequired()])
    fechaFinal = DateField("Fecha de salida", validators = [DataRequired()])
    numHabitacion = StringField("N° Habitación", validators = [DataRequired()])
    codigoReserva = StringField("Codigo de la Reserva")
    realizarReservaAdmin = SubmitField("Realizar Reserva", id="realizarReservaAdmin", name="button")

class EditarReservaAdmin(FlaskForm):
    numId = StringField("N° Identificación del Usuario", validators = [DataRequired()])
    fechaInicio = DateField("Fecha de entrada", validators = [DataRequired()])
    fechaFinal = DateField("Fecha de salida", validators = [DataRequired()])
    numHabitacion = StringField("N° Habitación", validators = [DataRequired()])
    codigoReserva = StringField("Codigo de la Reserva",  validators = [DataRequired()])
    editarReservaAdmin = SubmitField("Editar Reserva", id="editarReservaAdmin", name="button")

class EliminarReservaAdmin(FlaskForm):
    codigoReserva = StringField("Codigo de la Reserva",  validators = [DataRequired()])
    eliminarReservaAdmin = SubmitField("Eliminar Reserva", id="editarReservaAdmin", name="button")